...
fun getFavoriteMovies(): List<Movie> {
    return listOf(
        ...
        Movie(3,"Harry Potter and the Prisoner of Askaban",
            ...
            "fantasy", "https://www.imdb.com/title/tt0304141/"),
        Movie(4,"Harry Potter and the Deathly Hallows: Part 2",
            ...
            "fantasy", "https://www.imdb.com/title/tt1201607/"),
        Movie(5,"Winnetou",
            ...
            "western", "https://www.imdb.com/title/tt0057687/"),
...
fun getRecentMovies(): List<Movie> {
    return listOf(
        ...
        Movie(4,"Dungeons & Dragons: Honor Among Thieves",
            ...
            "fantasy", "https://www.imdb.com/title/tt2906216/"),
        Movie(5,"Scream VI",
            "In the next installment, the survivors of the Ghostface killings leave Woodsboro behind and start a fresh chapter in New York City.",
            "10.03.2023.","https://www.imdb.com/title/tt17663992/",
            "horror", "https://www.imdb.com/title/tt17663992/"),
        Movie(6,"Love again",
            ...
            "romance", "https://www.imdb.com/title/tt10276482/"),
    )
}